    ...
    {#if contact?.pendingConnection}
      <div class='flex flex-col items-center bg-tertiary-500 dark:bg-secondary-500 rounded-xl p-4 mx-8'>
        ...
        <div class='flex justify-center'>
          <Button moreClasses='bg-surface-100 text-sm text-secondary-500 dark:text-tertiary-100 font-bold dark:bg-secondary-900' onClick={() => { console.log('click', contact?.publicKeyB64, contact?.privateConversation); contact?.privateConversation?.copyInviteCodeForAgent(contact?.publicKeyB64) }}>
