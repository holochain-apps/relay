...
const config = ({
  loaders: [
    ...
    },
    {
      ...
      loader: async () => (
        await import('./translations/en/conversations.json')
      ).default,
    },
    {
      locale: 'ca',
      ...
      loader: async () => (
        await import('./translations/en/create.json')
      ).default,
    },
    {
      locale: 'de',
    ...
    },
    {
      ...
      loader: async () => (
        await import('./translations/de/contacts.json')
      ).default,
    },
    {
      locale: 'de',
      ...
      routes: [/^\/conversations(.*)/, '/create'], // you can use regexes as well!
      loader: async () => (
        await import('./translations/de/conversations.json')
      ).default,
    },
    {
      locale: 'de',
      ...
      loader: async () => (
        await import('./translations/de/create.json')
      ).default,
    },
  ]
});
